...
Selection state lives in a JSON file alongside the rendered HTML report,
e.g. ``Outputs/final_ranking_2025Q4_selection.json``. The local HTTP
server (``scripts/6_serve_report.py``) reads/writes this file in response
to GET/PUT from the browser; the pipeline (``scripts/6_score.py
...
Decision: 2_Funds_parser/spec/decisions.md § D48, D49.
"""
